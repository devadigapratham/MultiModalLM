...
def resize(
    image: Image.Image,
    size: Tuple[int, int],
    resample: Optional[int] = Image.BICUBIC,
...
class PaliGemmaProcessor:
    ...
    def __init__(self, tokenizer, num_image_tokens: int, image_size: int):
        ...
        EXTRA_TOKENS = [f"<loc{i:04d}>" for i in range(1024)]  # Object detection tokens
        EXTRA_TOKENS += [f"<seg{i:03d}>" for i in range(128)]  # Segmentation tokens
